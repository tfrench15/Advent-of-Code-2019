...
impl Wire {
    ...
    fn intersections(&self, other: &Wire) -> Vec<Point> {
        ...
        for key in self.points.keys() {
            if other.points.contains_key(key) {
                candidates.push(*key);
            }
        }
